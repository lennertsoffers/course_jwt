...
public class ExceptionHandling {
    ...
    private static final String NOT_ENOUGH_PERMISSION = "You do not have enough permissions";
    ...
    public ResponseEntity<HttpResponse> notFound404() {
        return this.createHttpResponse(NOT_FOUND, "There is no mapping for this path");
    }
